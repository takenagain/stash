...
[![Pub Package](https://img.shields.io/pub/v/stash_hive_ce.svg?style=flat-square)](https://pub.dartlang.org/packages/stash_hive_ce)
[![Coverage Status](https://codecov.io/gh/ivoleitao/stash/graph/badge.svg?flag=stash_hive_ce)](https://codecov.io/gh/ivoleitao/stash_hive_ce)
[![Package Documentation](https://img.shields.io/badge/doc-stash_hive_ce-blue.svg)](https://www.dartdocs.org/documentation/stash_hive_ce/latest)
...
Add this to your `pubspec.yaml` (or create it) replacing x.x.x with the latest version of stash_hive_ce:
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/ivoleitao/stash/blob/develop/packages/stash_hive_ce/LICENSE) file for details
